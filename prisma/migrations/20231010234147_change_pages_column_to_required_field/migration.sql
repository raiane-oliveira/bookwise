...
INSERT INTO "new_books" ("author", "category_id", "created_at", "id", "image_url", "name", "pages", "rating", "year") SELECT "author", "category_id", "created_at", "id", "image_url", "name", "pages", "rating", "year" FROM "books";
DROP TABLE "books";
